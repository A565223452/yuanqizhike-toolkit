...
async function setCorsHeader(context) {
  ...
  // CSP安全策略：允许谷歌广告脚本加载 + Giscus评论
  response.headers.set(
    "Content-Security-Policy",
    "default-src 'self'; " +
    "script-src 'self' https://pagead2.googlesyndication.com https://www.googletagmanager.com https://www.google.com https://www.gstatic.com https://giscus.app 'unsafe-inline'; " +
